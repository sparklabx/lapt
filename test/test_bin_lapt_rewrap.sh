...
# already has share/misc/magic. rewrap wraps it for the first time and
# exports MAGIC, resolved to that already-bundled path.
test_rewrap_first_time_wraps_via_pkgenv() {
  ...
  printf 'magic' > "$opt_dir/share/misc/magic"
